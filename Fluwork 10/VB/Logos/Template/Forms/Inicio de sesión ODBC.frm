...
Begin VB.Form frmODBCLogon 
   ...
   Begin VB.Frame fraStep3 
      Caption         =   "Valores de la conexión"
      Height          =   2415
      Index           =   0
      Left            =   120
      TabIndex        =   14
...
Private Sub cmdOK_Click()
    ...
    MsgBox "Para abrir un objeto de bases de datos DAO, use:" & vbCrLf & _
    "Set gDatabase = OpenDatabase(vbNullString, 0, 0, sDAOConnect)" & vbCrLf & vbCrLf & _
    "Y para abrir un conexión RDO, use:" & vbCrLf & _
