...
Print #7, ".marcas td{width:140px;height:54px;text-align:center;vertical-align:middle;padding:0;}"
...
Print #7, ".firma-title.entrega{background:#888;}"
...
Print #7, "@media print{body{padding:8px 12px;}}"
...
Print #7, "<br><span>Llamar el d&iacute;a:</span> "
...
Print #7, "Se cobrar&aacute; un valor de $3.500 + IVA en concepto de presupuesto y diagn&oacute;stico del equipo, s&oacute;lo en caso en que el cliente opte por retirar el equipo sin efectuar la reparaci&oacute;n del mismo."
Print #7, "</div>"
...
Print #7, "<div class=""firma-body"">"
Print #7, "<div style=""display:flex;gap:20px;"">"
Print #7, "<div style=""flex:0 0 180px;text-align:center;"">"
...
Print #7, "<div class=""firma-label"">Aclaraci&oacute;n</div>"
Print #7, "</div>"
Print #7, "<div style=""flex:1;display:flex;flex-direction:column;justify-content:flex-end;"">"
Print #7, "<div style=""border-bottom:1px solid #333;padding-bottom:3px;margin-bottom:3px;min-height:30px;"">&nbsp;</div>"
Print #7, "<div class=""firma-label"">Retirado por (nombre completo y DNI)</div>"
Print #7, "</div></div></div></div>"
